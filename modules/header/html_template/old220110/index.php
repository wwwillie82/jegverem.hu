<div id="header">
    <div class="holder">
        ...
        <div id="menu">
            <span><a href="/index" <? if($_SERVER["REQUEST_URI"] == "/index" || $_SERVER["REQUEST_URI"] == "/"): ?>class="on"<? endif; ?>>Főoldal</a></span>
            ...
            <span><a href="/kapcsolat" <? if($_SERVER["REQUEST_URI"] == "/kapcsolat"): ?>class="on"<? endif; ?>>Kapcsolat</a></span>
			<span class="no"><a href="/kisfaludy_program" <? if($_SERVER["REQUEST_URI"] == "/kisfaludy_program"): ?>class="on"<? endif; ?>>Kisfaludy program</a></span>
        </div>
		...
		<div class="fb-like" data-href="https://www.facebook.com/jegverem.fogado" data-width="50" data-layout="button_count" data-action="like" data-show-faces="true" data-share="true"></div>
    </div>
</div>