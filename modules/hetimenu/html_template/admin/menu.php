...
<tr <? if($menus->IsOdd()): ?>class="dark"<? endif; ?> >
	<td align="center" valign="middle"><?php echo $menu->id; ?></td>
	<td align="left" valign="middle"><?php echo $menu->week; ?></td>
	<td align="center" valign="middle"><a href="<?php echo ModuleHelper::GetFunctionLink("admin/edit_menu", array("week" => $menu->week, "companies_id" => $menu->companies_id)); ?>"><img src="/images_admin/icons/icon_edit.png" alt="Menük"/></a></td>
	<td align="center" valign="middle"><a href="<?php echo ModuleHelper::GetFunctionLink("admin/menu/delete", array("week" => $menu->week, "companies_id" => $menu->companies_id)); ?>"><img src="/images_admin/icons/icon_delete.png" alt="Szerkeszt"/></a></td>
</tr>
<? endforeach; ?>
</tbody>
</table>
