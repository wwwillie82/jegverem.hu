...
<div class="data">
	<div class="form">
		<?= Form::StartForm("edit", ModuleHelper::GetFunctionLink("admin/edit", array("id" => $item->id)), "post", "multipart/form-data") ?>

		<div class="item">
			<label><span>*</span> <?= Localization::_("Parent location") ?></label>
			<div class="ckeditor">
				<script type="text/javascript">
					expandbox.render(true);
					expandbox.renderHiddenInput("category_id");
					expandbox.setSelected('<?= $item->id ?>', false);
				</script>
				<br class="clearfix" />
			</div>
			<br class="clearfix"/>
		...
		<div class="item">
			<label><span>*</span> <?= Localization::_("Title") ?></label>
			<input type="text" name="title" value="<?= $item->title ?>" class="input_normal" />
			<br class="clearfix"/>
		</div>
		
		<div class="item">
			<label><span>*</span> <?= Localization::_("Rövid leírás") ?></label>
			<textarea name="description" class="textfield_small"><?= $item->description ?></textarea>
			<br class="clearfix"/>
        ...
        <div class="item">
			...
			<input type="text" name="sort_order" value="<?= $item->sort_order ?>" class="input_normal" />
			<br class="clearfix"/>
		...
		<div class="item">
			...
			<input type="text" name="from_date" value="<?= $item->from_date ?>" class="input_normal" />
			<br class="clearfix"/>
			<div class="info">Csak az aktuális ajánlatoknál kell kitölteni.</div>
		</div>
		...
		<div class="item">
			...
			<input type="text" name="to_date" value="<?= $item->to_date ?>" class="input_normal" />
			<br class="clearfix"/>
			<div class="info">Csak az aktuális ajánlatoknál kell kitölteni.</div>
		</div>

		<div class="item">
			<label><span class="required">* <?= Localization::_("Required") ?></span></label>
