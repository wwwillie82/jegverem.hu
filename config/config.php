...
$config["db_username"] = "jegverem";
$config["db_password"] = "9yMXUyBHfwKLpuBM";
$config["db_connect"] = "db.pregiatohosting.com";
$config["db_dbname"] = "jegverem";
$config["db_adapter"] = "DbMySQLAdapter";
$config["db_is_cached"] = true;
$config["db_cache_adapter"] = "MemCacheServer";

// Log beállításai
$config["log_directory"] = "/home/users/jegv/logs";
...
// SMTP beállítások
$config["smtp_server"][0] = "posta.voov.hu";
$config["smtp_port"][0] = "25";
$config["smtp_username"][0] = "pingback.voov";
$config["smtp_password"][0] = "ABCDEF12345";
