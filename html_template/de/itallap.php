...
<!--<script defer async src='https://cdn.trustindex.io/loader.js?0b42a8965ce451e6142286174'></script> -->
		<div id="middle">
			<div class="tabs">
				...
				<?php if($aktualis->length() > 0): ?><span><a href="/de/aktualis_ajanlat">Aktuelle Angebote</a></span><?php endif; ?>
			</div>
			<div class="main_full">
				<div class="content">
					...
					<div class="menu-accordion" data-menu-accordion="1">
						...
						<div class="menu-accordion__item <?php if($cat->id == $products->categories_id): ?>open<?php endif; ?>">
							...
							<div class="menu-accordion__panel">
								...
								<?php foreach($items as $drink_product): ?>
								<div class="menu-mitem">
									<div class="menu-mitem__row">
										<span class="menu-mitem__name">
											<?= $drink_product->name ?>
											<?php if($drink_product->description != ""): ?>
											<small><?= $drink_product->description ?></small>
											<?php endif; ?>
										</span>
										<span class="menu-mitem__price"><?php if($drink_product->price > 0): ?><span><?= $drink_product->attribute ?></span> <?= $drink_product->price ?>,-<?php endif; ?></span>
									</div>
									<?php if($drink_product->pic_path != ""): ?>
			...
			<div class="sidebar_full">
				<div class="navigation">
					<?php foreach($categories as $cat): ?>
					<a href="<?= URI::MakeURL("de/itallap", array("filter" => $cat->permalink), true) ?>" <?php if($cat->id == $products->categories_id): ?>class="on"<?php endif; ?>><?= $cat->title ?></a>
					<?php endforeach; ?>
				</div>
				<div class="fix"></div>
