				...
				<div class="holder" id="block_1">
					<div id="scrollbar1">
						...
						<div class="viewport">
							 <div class="overview">
								<? if($menus->length() > 0): ?>
									<h3 style="line-height: 22px;">Ezen a héten (<?= $menus->week ?>. hét)<br />A menü ára: 1.290 Ft<br />Csomagolás: 100 Ft/étel </h3>
								...
								<? if($next_menus->length() > 0): ?>
									<h3 style="line-height: 22px;">Következő a héten (<?= $next_menus->week ?>. hét)<br />A menü ára: 990 Ft /1.290 Ft</h3>
