    ...
    <div id="middle">
        <div class="main">
            ...
            <div class="content">
                ...
                <ul>
                    <li><span>Címünk:</span> H-9400 Sopron, Jégverem u. 1.</li>
                    <li><span>Házhoz szállítás/Asztalfoglalás:</span>
                    Telefonon: (+36) 99/510-113, E-mailben: jegverem@jegverem.hu</li>
					<li><span>Szobafoglalás:</span>
                ...
                <ul>
					...
					<li>Kedd: 11-22</li>
					<li>Szerda: 11-22</li>
					<li>Csütörtök: 11-22</li>
					<li>Péntek: 11-24</li>
					<li>Szombat: 11-24</li>
					<li>Vasárnap: 11-20</li>
                </ul>
