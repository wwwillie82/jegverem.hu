    ...
    <div id="middle">
        <div class="main">
            ...
            <div class="content">
                ...
                <ul>
                    <li><span>Adresse:</span> H-9400 Sopron, Jégverem u. 1.</li>
                    <li><span>Buchung:</span>
                    Rufnummer: (+36) 99/510-113, Email: jegverem@jegverem.hu</li>
                </ul>
				...
				<ul>
					<li>Montag: 11-22</li>
					<li>Dienstag: 11-22</li>
					<li>Mittwoch: 11-22</li>
					<li>Donnerstag: 11-22</li>
					<li>Freitag: 11-24</li>
					<li>Samstag: 11-24</li>
					<li>Sonntag: 11-20</li>
                </ul>
