...
<?php $__pageBodyClass = "page-a_panziorol"; if (isset($body_class) && trim($body_class) != "") { $__pageBodyClass = trim($body_class . " " . $__pageBodyClass); } ?>
...
<script defer async src='https://cdn.trustindex.io/loader.js?f9074e46542e48ecf4781fac1'></script>
    ...
    <div id="middle">
        <div class="main">
            <div class="top"></div>
            <div class="content">
                <center><h2>Accommodation at the Jégverem Inn</h2></center>
                ...
                <div class="panel-box">
                    ...
                    <ul>
                        <li>Check-in: between 3:00 PM and 7:00 PM</li>
