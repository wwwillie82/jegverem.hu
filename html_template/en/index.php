    ...
    <div id="middle">
        <div class="box_two">
            <div class="covers">
                ...
                <div class="item SlideShow" style="background-image: url(http://<?= $_SERVER["HTTP_HOST"] ?>/<?= $url ?>);">
                    <div class="navigation">
						...
						<button type="button" class="prev SlideShowControlPrev" aria-label="Previous slide">Prev</button>
						<button type="button" class="next SlideShowControlNext" aria-label="Next slide">Next</button>
                    </div>
                </div>
				<? $i++; endforeach; ?>
            </div>
            ...
            <div class="offers">
				<div class="head">
					...
					<span><a href="/en/aktualis_ajanlat" class="no">Current offer</a></span>
					<? endif; ?>
				</div>
        ...
        <div class="mobile-home-tiles">
            <div class="home-tile item home-card-mini">
                <div class="home-card-mini-media"><img src="/images/skin_v2/heti_menu.jpg" alt="Weekly menu" /></div>
                <div class="home-tile-body home-card-mini-body">
                    <p class="home-tile-title home-card-mini-title">Weekly menu</p>
                    <p>Enjoy our daily specials every weekday from 12:00 PM to 3:00 PM!</p>
                    <a href="/en/heti_menu" class="home-tile-cta home-card-mini-btn">Weekly menu >></a>
                </div>
            </div>

            <div class="home-tile item home-card-mini">
                <div class="home-card-mini-media"><img src="/images/skin_v2/privat_rendezvenyek_jegverem_sopron.jpeg" alt="Private events" /></div>
                <div class="home-tile-body home-card-mini-body">
                    <p class="home-tile-title home-card-mini-title">Private events in Sopron</p>
                    <p>If you’re looking for the perfect venue for a birthday, a gathering with friends, a business or family event, or even a private class reunion, you’ve come to the right place!</p>
                    <a href="/en/privat_rendezvenyek" class="home-tile-cta home-card-mini-btn">Private events in Sopron >></a>
                </div>
            </div>
        </div>
