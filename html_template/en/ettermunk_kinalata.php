    ...
    <div id="middle">
        ...
        <div class="sidebar_full">
			<div class="navigation">
				...
				<a href="<?php echo URI::MakeURL("en/ettermunk_kinalata", array("filter" => $cat->permalink), true); ?>" <? if($cat->id == $products->categories_id): ?>class="on"<? endif; ?>><?php echo $cat->title; ?></a>
				<? endforeach; ?>
			</div>
			<div class="fix"></div>
