...
<!-- <script defer async src='https://cdn.trustindex.io/loader.js?f9074e46542e48ecf4781fac1'></script> -->
    ...
    <div id="middle">
		<div class="tabs">
			<span><a href="/en/ettermunk_kinalata" class="on">Menu</a></span>
			<span class="drinks-tab"><a href="/en/itallap">Drinks</a></span>
		</div>
        ...
        <div class="sidebar_full">
			<div class="navigation">
				<?php foreach($categories as $cat): ?>
				<a href="<?= URI::MakeURL("en/ettermunk_kinalata", array("filter" => $cat->permalink), true) ?>" <?php if($cat->id == $products->categories_id): ?>class="on"<?php endif; ?>><?= $cat->title ?></a>
				<?php endforeach; ?>
			</div>
			<div class="fix"></div>
