    ...
    <div id="middle">
				...
				<div class="holder" id="block_1">
					<div id="scrollbar1">
						...
						<div class="viewport">
							 <div class="overview">
								<? if($menus->length() > 0): ?>
									<h3 style="line-height: 22px;">This week (<?php echo $menus->week; ?>. week)<br />Weekly menu price: 990 HUF / 1290 HUF<br />Packing: 100 HUF/food </h3>
								...
								<? if($next_menus->length() > 0): ?>
									<h3 style="line-height: 22px;">Next week (<?php echo $next_menus->week; ?>. week)<br />Weekly menu price: 990 HUF / 1290 HUF</h3>
        ...
        <div class="box_three">
            ...
            <div class="item">
                ...
                <div class="text">
                    <p><span style="color: red; font-weight: bold;">Every day</span> the "Jégverem Waiter" is going to your house <span style="color: red; font-weight: bold;">between 11.00-22.00!</span></p>
