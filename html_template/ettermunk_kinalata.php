...
<div id="container">
    ...
    <div id="middle">
		<div class="tabs">
			...
			<span class="drinks-tab"><a href="/itallap">Itallap</a></span>
        ...
        <div class="sidebar_full">
			<div class="navigation">
				<?php foreach($categories as $cat): ?>
				<a href="<?= URI::MakeURL("ettermunk_kinalata", array("filter" => $cat->permalink), true) ?>" <?php if($cat->id == $products->categories_id): ?>class="on"<?php endif; ?>><?= $cat->title ?></a>
				<?php endforeach; ?>
			</div>
			<div class="fix"></div>
