<?	
	class Itallap extends Controller {		
		function main() {			
			...
			$qb = QueryBuilder::QueryBuilder()->Select()->From("categories")->Where("parent_id='106'")->OrderBy("sort_order");			
			...
			$category_id = $this->db->Query("SELECT * FROM categories WHERE parent_id='106' ORDER BY sort_order LIMIT 0,1")->id;			
			}						
